...
<div class="d-flex">
  ...
  <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 6 6 0 0 1 3.13-1.567"/>
        ...
        <a href="/sdi/{{$practica->id}}" class="nav-link text-white ps-2 ">SDI</a>
      </li>
      ...
      <li class="nav-item d-flex align-items-center px-3 p-2 btncursor">
        ...
        <a href="/imss/{{$practica->id}}" class="nav-link text-white ps-2 ">IMSS</a>
      </li>
      ...
      <li class="nav-item d-flex align-items-center px-3 p-2 btncursor">
        ...
        <a href="/aguinaldo/{{$practica->id}}" class="nav-link text-white ps-2 ">Aguinaldo</a>
      </li>
      ...
      <li class="nav-item d-flex align-items-center px-3 p-2 btncursor">
        ...
        <a href="/costoimss/{{$practica->id}}" class="nav-link text-white ps-2 ">Costo IMSS</a>
      </li>
      ...
      <li class="nav-item d-flex align-items-center px-3 p-2 btncursor">
        ...
        <a href="/cuotasimss/{{$practica->id}}" class="nav-link text-white ps-2 ">Cuotas IMSS</a>
      </li>
